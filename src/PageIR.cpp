...
void startIRPage(void) {
    ...
    TouchSliderVelocity.setCaptionProperties(TEXT_SIZE_11, FLAG_SLIDER_CAPTION_ALIGN_LEFT, 4, COLOR16_RED,
    ...
    TouchSliderPitch.setBarBackgroundColor(COLOR16_YELLOW);
    TouchSliderPitch.setCaptionProperties(TEXT_SIZE_11, FLAG_SLIDER_CAPTION_ALIGN_LEFT, 4, COLOR16_RED,
    COLOR_BACKGROUND_DEFAULT);
    ...
    TouchSliderYaw.setCaptionProperties(TEXT_SIZE_11, FLAG_SLIDER_CAPTION_ALIGN_MIDDLE, 4, COLOR16_RED,
    COLOR_BACKGROUND_DEFAULT);
    TouchSliderYaw.setCaption(StringYaw);
    TouchSliderYaw.setPrintValueProperties(TEXT_SIZE_11, FLAG_SLIDER_CAPTION_ALIGN_LEFT, 4, COLOR16_BLUE,
    COLOR_BACKGROUND_DEFAULT);
