...
//Amplitude slider
    ...
    TouchSliderAmplitude.setCaptionProperties(TEXT_SIZE_11,
            FLAG_SLIDER_VALUE_CAPTION_ALIGN_LEFT | FLAG_SLIDER_VALUE_TAKE_DEFAULT_MARGIN, 0, COLOR16_RED, BACKGROUND_COLOR);
    TouchSliderAmplitude.setCaption("Amplitude");
    TouchSliderAmplitude.setPrintValueProperties(TEXT_SIZE_11,
            FLAG_SLIDER_VALUE_CAPTION_ALIGN_MIDDLE | FLAG_SLIDER_VALUE_TAKE_DEFAULT_MARGIN, 0, COLOR16_BLUE, BACKGROUND_COLOR);
...
//Offset slider
    ...
    TouchSliderOffset.setCaptionProperties(TEXT_SIZE_11, FLAG_SLIDER_VALUE_CAPTION_ALIGN_RIGHT | FLAG_SLIDER_VALUE_TAKE_DEFAULT_MARGIN, 0,
            COLOR16_RED, BACKGROUND_COLOR);
