 ...
 * @{
 */
/** @addtogroup MI0283QT2_basic
 * @{
 */
#define LCD_GRAM_WRITE_REGISTER    0x22

bool isInitializedMI0283QT2 = false;
...
// One instance of MI0283QT2 called LocalDisplay
MI0283QT2 LocalDisplay;
//-------------------- Public --------------------
void MI0283QT2::init(void) {
//init pins
    MI0283QT2_IO_initalize();
...
void MI0283QT2::clearDisplay(uint16_t aColor) {
    unsigned int size;
...
void MI0283QT2::drawLine(uint16_t aXStart, uint16_t aYStart, uint16_t aXEnd, uint16_t aYEnd, uint16_t aColor) {
    drawLineOverlap(aXStart, aYStart, aXEnd, aYEnd, LINE_OVERLAP_NONE, aColor);
}

void MI0283QT2::fillRect(uint16_t aXStart, uint16_t aYStart, uint16_t aXEnd, uint16_t aYEnd, uint16_t aColor) {
    uint32_t size;
    uint16_t tmp, i;
...
void MI0283QT2::drawCircle(uint16_t aXCenter, uint16_t aYCenter, uint16_t aRadius, uint16_t aColor) {
    int16_t err, x, y;
...
void MI0283QT2::fillCircle(uint16_t aXCenter, uint16_t aYCenter, uint16_t aRadius, uint16_t aColor) {
    int16_t err, x, y;
 ...
 */
void MI0283QT2::drawLineFastOneX(uint16_t aXStart, uint16_t aYStart, uint16_t aYEnd, uint16_t aColor) {
    uint8_t i;
    bool up = true;
//calculate direction
 ...
 * @return uint16_t start x for next character - next x Parameter
 */
uint16_t MI0283QT2::drawText(uint16_t aXStart, uint16_t aYStart, const char *aStringPtr, uint8_t aSize, uint16_t aColor,
        uint16_t aBGColor) {
    uint16_t tLength = 0;
...
uint16_t MI0283QT2::drawNCharacters(uint16_t aXStart, uint16_t aYStart, const char *aStringPtr, uint8_t aSize, uint16_t aColor,
 ...
 */
void MI0283QT2::drawTextVertical(uint16_t aXPos, uint16_t aYPos, const char *aStringPointer, uint8_t aSize, uint16_t aColor,
 ...
 */
uint16_t MI0283QT2::drawMLText(uint16_t aPosX, uint16_t aPosY, const char *aStringPtr, uint8_t aTextSize, uint16_t aColor,
        uint16_t aBGColor) {
