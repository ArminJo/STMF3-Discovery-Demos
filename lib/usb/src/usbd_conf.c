...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
PCD_HandleTypeDef PCDHandle; // Peripheral Controller Driver
 ...
 * @retval None
 */
void HAL_PCD_MspInit(PCD_HandleTypeDef *aUSBHandle) {
